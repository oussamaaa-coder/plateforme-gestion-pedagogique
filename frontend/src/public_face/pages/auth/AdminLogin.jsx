      ...
      <div className="auth-card admin">
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="auth-options">
            ...
            <a href="#" className="auth-forgot-link" onClick={(e) => {e.preventDefault(); toast.info("Contactez le support technique.")}}>
              Mot de passe oublié ?
            </a>
          </div>
